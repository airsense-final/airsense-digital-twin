...
const API_URL =
  (import.meta as any).env?.VITE_API_URL || "https://localhost:8001";
const WS_URL = (import.meta as any).env?.VITE_WS_URL || "wss://localhost:8001";
  ...
  useEffect(() => {
    const fetchInitialData = async () => {
      ...
      try {
        ...
        const thRes = await axios.get(`${API_URL}/api/v1/thresholds/`, {
          ...config,
          params,
        });
        setThresholds(thRes.data);

        const res = await axios.get(`${API_URL}/api/digital-twin-data`, {
